        ...
        messages: [
          {
            ...
            content:
              ...
              "(never invent an id outside this list). Return ONLY a JSON array of objects " +
              '{"id": "<candidate id>", "why": "<one short sentence, specific to this user need>"}, ' +
              "most relevant first, max 6. If nothing fits, return []. No prose outside the JSON array.",
          },
